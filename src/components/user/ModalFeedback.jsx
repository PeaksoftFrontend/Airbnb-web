...
export const ModalFeedback = ({ open = true, onClose }) => {
        ...
        <StyledContainer>
          <Box>
            ...
            <StyledTextPhoto>
              ...
              <StyledDivText>
                <StyledFirst variant="h6">Add photos to the review</StyledFirst>
                <StyledSecond variant="inherit">
...
const StyledFirst = styled(Typography)({
  color: "#266BD3",
  fontWeight: "500",
  fontSize: "16px",
});
